			...
			, success : function(data){
				if(data!=null){
					if(data.check_order_num=='cus'){
						...
						$("#contecntTable1 td:eq(5)").text(comma(data.book_qty)+'권');
						$("#contecntTable1 td:eq(6)").text(data.publisher);
						$("#contecntTable1 td:eq(7)").text(comma(data.book_price)+'원');
						$("#contecntTable1 td:eq(8)").text(comma(data.all_book_price)+'원');
					...
					if(data.check_order_num=='corp'){
						if(data.branch_name==null){
							...
							$("#contecntTable2 td:eq(8)").text(comma(data.book_qty)+'권');
							$("#contecntTable2 td:eq(9)").text(data.publisher);
							$("#contecntTable2 td:eq(10)").text(comma(data.book_price)+'원');
							$("#contecntTable2 td:eq(11)").text(comma(data.all_book_price)+'원');
