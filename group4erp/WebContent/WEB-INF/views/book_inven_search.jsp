				...
				<tr>
					...
					<c:forEach items="${requestScope.BookList}" var="book" varStatus="loopTagStatus">
							<tr style="cursor: pointer" onClick="goBookContentForm(${book.ISBN13});">
								...
								<td align=center><fmt:formatNumber type="number" maxFractionDigits="3" value="${book.book_price}" />원
								<td align=center><fmt:formatNumber type="number" maxFractionDigits="3" value="${book.book_cnt}" />
